...
| 文档 | 类型 | 状态 | 说明 |
|------|------|------|------|
| [01_整体功能需求.md](01_整体功能需求.md) | 功能需求 | 🟢 活跃 | 四大模块 + 9 阶段 PBL + MVP 范围（2026-07-30 新增） |
| [02_模块说明.md](02_模块说明.md) | 模块说明 | 🟢 活跃 | 前后端各模块职责 + AI 主链路（2026-07-30 新增） |
| [03_技术架构.md](03_技术架构.md) | 技术架构 | 🟢 活跃 | 技术栈 + 端口 + ZeroClaw 集成（2026-07-30 新增） |
| [04_数据结构和数据架构.md](04_数据结构和数据架构.md) | 数据架构 | 🟢 活跃 | 数据库表 + workspace + 数据关系（2026-07-30 新增） |
