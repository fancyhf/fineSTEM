...
- 上一轮 QA 报告：[round1_report.md](../round1_report.md) / [round1_summary.json](../round1_summary.json)
...
5. Report：写两份产物
   - Markdown：.trae/documents/testing/round2_report.md
   - JSON：.trae/documents/testing/round2_summary.json（schema 见本文件第 5 节）
...
| 用例 ID | 路径 | 入口 | 预期 | 证据 |
|---|---|---|---|---|
| S-01 | A smoke | `python scripts/run_create_smoke.py` | `overall_passed: true`；产物 summary JSON 落盘 `.trae/documents/testing/create-smoke-summary_*.json` | summary JSON |
...
QA 工具必须按此 schema 写 `.trae/documents/testing/round2_summary.json`：
...
```json
{
  ...
  "report_md_path": ".trae/documents/testing/round2_report.md",
  "report_json_path": ".trae/documents/testing/round2_summary.json",
