...
class HongKongMacaoPlanModel(AuditMixin, Base):
    __tablename__ = "hk_macao_plans"
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    owner_id: Mapped[str] = mapped_column(String(64), index=True)
    student_name: Mapped[str] = mapped_column(String(100))
    grade: Mapped[str] = mapped_column(String(50))
    target_track: Mapped[str] = mapped_column(String(16), default="both")
    timeline: Mapped[str] = mapped_column(Text, default="")
    requirement_summary: Mapped[str] = mapped_column(Text, default="")
    status: Mapped[str] = mapped_column(String(16), default="draft")


class InternationalPlanModel(AuditMixin, Base):
    __tablename__ = "international_plans"
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    owner_id: Mapped[str] = mapped_column(String(64), index=True)
    student_name: Mapped[str] = mapped_column(String(100))
    grade: Mapped[str] = mapped_column(String(50))
    target_country: Mapped[str] = mapped_column(String(100))
    target_school_level: Mapped[str] = mapped_column(String(64), default="undergraduate")
    timeline: Mapped[str] = mapped_column(Text, default="")
    requirement_summary: Mapped[str] = mapped_column(Text, default="")
    status: Mapped[str] = mapped_column(String(16), default="draft")


class ProfileEnhancementPlanModel(AuditMixin, Base):
    __tablename__ = "profile_enhancement_plans"
    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    owner_id: Mapped[str] = mapped_column(String(64), index=True)
    student_name: Mapped[str] = mapped_column(String(100))
    objective: Mapped[str] = mapped_column(String(300))
    activities: Mapped[str] = mapped_column(Text, default="[]")
    evidence_targets: Mapped[str] = mapped_column(Text, default="[]")
    status: Mapped[str] = mapped_column(String(16), default="draft")


class KnowledgeSourceModel(AuditMixin, Base):
...
class QuestionnaireTemplateModel(AuditMixin, Base):
